...
//                R.id.navigationShipin to ShipinFragment(),
    ...
    private fun restoreFragments(savedInstanceState: Bundle) {
        ...
        val zitiFragment = supportFragmentManager.findFragmentByTag(R.id.navigationLuzhi.toString()) as? LuzhiFragment
            ?: LuzhiFragment()
//            val duanyuFragment = supportFragmentManager.findFragmentByTag(R.id.navigationShipin.toString()) as? ShipinFragment
//                ?: ShipinFragment()
        val wodeFragment = supportFragmentManager.findFragmentByTag(R.id.navigationWode.toString()) as? WodeFragment
            ?: WodeFragment()

        fragments = mapOf(
            R.id.navigationLuzhi to zitiFragment,
//                R.id.navigationShipin to duanyuFragment,
            R.id.navigationWode to wodeFragment
        )
    }
